...
public class UIManager : SingletonManager<UIManager>
{
    ...
    private GameObject GenerateViewObj(string viewName, ViewBase view)
    {
        ...
        GameObject prefab = ResourceManager.Instance.LoadRes<GameObject>(ResDef.VIEW_PATH, $"{viewName.ToLower()}.assetbundle", viewName);
    ...
    private IEnumerator GenerateViewObjAsync(string viewName, ViewBase view)
    {
        ...
        yield return ResourceManager.Instance.LoadResAsync<GameObject>(ResDef.VIEW_PATH, $"{viewName.ToLower()}.assetbundle", viewName, (res)=>
        {
            prefab = res;
        });
